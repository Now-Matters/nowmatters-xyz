    ...
    <section className="info-section alt" id="how-to-get">
      <div className="container">
        <div className="section-intro centered">
          <p className="eyebrow">How to get $NOW</p>
        ...
        <div className="verify-box">
          ...
          <div>
            <p className="stat-label">Stay safe</p>
            <p>Only use links from this website, never share your seed phrase, and always check the contract address.</p>
